...
import { RotateCcw, Clock, Truck } from 'lucide-react';
    ...
    <div className="px-4 mt-6">
      ...
      <div className="p-4 rounded-2xl flex items-center gap-3" style={{ background:'var(--cc-surface)', border:'1px solid rgba(255,255,255,0.04)'}}>
        ...
        <button onClick={handleReorder}
          className="flex items-center gap-1.5 px-4 py-2.5 rounded-full font-bold text-xs flex-shrink-0" style={{ background:'var(--cc-accent-2)', color:'var(--cc-black)'}}>
