    ...
    <div>
      <div className="flex items-center justify-between mb-1.5">
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-xs font-bold" style={{ color: 'var(--cc-ink-dim)' }}>{label}</span>
        </div>
        <span className="text-xs font-black" style={{ color }}>{value}g</span>
      </div>
      <div className="h-2 rounded-full overflow-hidden" style={{ background: 'var(--cc-bg-3)' }}>
        ...
        {result && !analyzing && (
          <>
            ...
            <div className="p-5 rounded-3xl flex flex-col gap-4"
              ...
              <MacroBar label="Fat" value={result.macros?.fat_g || 0} max={60} color="var(--cc-warm)" icon={Droplets} />
              <MacroBar label="Fiber" value={result.macros?.fiber_g || 0} max={30} color="var(--cc-accent)" icon={Leaf} />
            </div>
