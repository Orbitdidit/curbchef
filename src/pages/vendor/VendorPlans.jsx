      ...
      <div className="px-5">
                  ...
                  <div className="flex flex-col gap-2 mb-5">
                    {plan.features.map(f => (
                      <div key={f} className="flex items-center gap-2">
                        ...
                        <span className="text-sm" style={{ color: 'var(--cc-ink)' }}>{f}</span>
                      </div>
                    ))}
                  </div>
                  {isActive ? (
        ...
        {activeTab === 'boosts' && (
          <div className="flex flex-col gap-4">
            ...
            <p className="text-xs" style={{ color: 'var(--cc-ink-dim)' }}>Credits are included monthly with paid plans, or can be purchased separately.</p>
            {BOOSTS.map(boost => {
