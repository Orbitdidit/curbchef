    ...
    <div className="min-h-screen dot-bg pb-10" style={{ background: 'var(--cc-black)' }}>
      ...
      <div className="px-5 pt-5 max-w-2xl mx-auto">
        ...
        <div className="flex items-center gap-2 mb-4">
          <TrendingUp className="w-4 h-4" style={{ color: 'var(--cc-accent-2)' }} />
          <p className="text-[10px] font-black tracking-widest" style={{ color: 'var(--cc-accent-2)' }}>RANKED BY UNITS SOLD</p>
        </div>

        {isLoading ? (
          <div className="flex items-center justify-center py-16">
            <div className="w-8 h-8 border-2 border-t-transparent rounded-full animate-spin" style={{ borderColor: 'var(--cc-accent-2) transparent transparent transparent' }} />
          </div>
        ) : ranked.length === 0 ? (
